...
const sendVerificationCode = (email, code) => {
    let html = `<tr style="margin: 0; padding: 0; font-family: Helvetica; box-sizing: border-box; font-size: 14px;">
        <td class="content-block" style="margin: 0; padding: 0 0 20px; font-family: Helvetica; box-sizing: border-box; font-size: 14px; vertical-align: top;">
            ...
            <p>Be sure to use this on the verification page, but if you accidentally lost access to that page, don't worry! Just login with your credentials and if your account isn't verified, it will bring you back to the same page.</p>
